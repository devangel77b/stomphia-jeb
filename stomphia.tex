...
\begin{figure}
\caption{ (A) Filming setup for still water, 16 x 8 x 10 \unit{inch}\ (40 x 20 x 26 \unit{cm}) glass aquarium with a \unit[45]{degree}\ mirror.  (B) Filming setup for �ow.  Flume with 50 x 16 x 16 \unit{cm}\ working section, operating between 0 and \unitfrac[0.2]{m}{s}.  Flume design as described in \citep{LaBarbera:1978}.}
\label{fig:2}
\end{figure}
